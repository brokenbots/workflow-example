...
# channel. This lets the runner mount only the Linear API key. Secret values
# are OriginRef strings ("kind:ref") parsed by the host's secret provider
# stack - they must stay quoted HCL strings.
